from aiwolf_nlp_common.protocol.gameInfo.map.remain_talk_map import (
    AgentRemainTalkInfo,
    RemainTalkMap,
)
...
def test_set_received_info(initialize_json: dict) -> None:
    test_map = RemainTalkMap.initialize_from_json(
        set_map=initialize_json["gameInfo"]["remainTalkMap"]
    )
